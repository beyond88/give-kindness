...
<div class="give-donor-dashboard-tab-content" id="give_kindness-profile" data-tab-content="give_kindness-profile">
   ...
   <div class="give-donor-dashboard-text-control">
      <label class="give-donor-dashboard-text-control__label" for="address-1-490">
         <?php echo __('Address 1', 'give-kindness'); ?>
      </label>
      <div class="give-donor-dashboard-text-control__input">
         <input id="address-1-490" type="text" value="<?php echo $address['line1']; ?>">
      </div>
   </div>
   <div class="give-donor-dashboard-text-control">
      <label class="give-donor-dashboard-text-control__label" for="address-2-759">
         <?php echo __('Address 2', 'give-kindness'); ?>
      </label>
      <div class="give-donor-dashboard-text-control__input">
         <input id="address-2-759" type="text" value="<?php echo $address['line2']; ?>">
      </div>
   </div>
   <div class="give-donor-dashboard-text-control">
      <label class="give-donor-dashboard-text-control__label" for="city-903">
