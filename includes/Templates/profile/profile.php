...
<div class="give-donor-dashboard-tab-content" id="givekindness-profile" data-tab-content="givekindness-profile">
   <div class="give-donor-dashboard-heading"><?php echo __('Profile Information', 'givekindness'); ?></div>
   <div class="give-donor-dashboard-divider"></div>
   <div class="give-donor-dashboard-avatar-control">
      <label class="give-donor-dashboard-avatar-control__label"><?php echo __('Avatar', 'givekindness'); ?></label>
        ...
        <div class="give-donor-dashboard-avatar-control__preview">
         ...
         <div class="give-donor-dashboard-avatar-control__dropzone">
            <div class="give-donor-dashboard-avatar-control__instructions">
               <p><?php echo __('Drag image here to set', 'givekindness'); ?> <br><?php echo __('avatar or', 'givekindness'); ?> <span class="give-donor-dashboard-avatar-control__select-link"><?php echo __('find image', 'givekindness'); ?></span></p>
            </div>
         </div>
      </div>
   </div>
   <div class="give-donor-dashboard-field-row">
      <div class="give-donor-dashboard-select-control" style="max-width: 120px;">
         <label class="give-donor-dashboard-select-control__label" for="prefix-224"><?php echo __('Prefix', 'givekindness'); ?></label>
         <div class="css-2b097c-container">
            <div class="givekindness-prefix-select">
               <div class="givekindness-form-item">
                  <div class="givekindness-prefix-singleValue">Ms.</div>
                  <div class="givekindness-form-child-item">
            ...
            <div class="givekindness-prefix-menu">
                <div class="css-1ew0esf">
                    <div class="givekindness-prefix-selector" tabindex="-1"><?php echo __('Mr.', 'givekindness'); ?></div>
                    <div class="givekindness-prefix-selector" tabindex="-1"><?php echo __('Ms.', 'givekindness'); ?></div>
                    <div class="givekindness-prefix-selector" tabindex="-1"><?php echo __('Mrs.', 'givekindness'); ?></div>
                </div>
            </div>
         </div>
      </div>
      <div class="give-donor-dashboard-text-control">
         <label class="give-donor-dashboard-text-control__label" for="first-name-699"><?php echo __('First Name', 'givekindness'); ?></label>
      ...
      <div class="give-donor-dashboard-text-control">
         <label class="give-donor-dashboard-text-control__label" for="last-name-804"><?php echo __('Last Name', 'givekindness'); ?></label>
   ...
   <div class="give-donor-dashboard-text-control">
      <label class="give-donor-dashboard-text-control__label" for="company-783"><?php echo __('Company', 'givekindness'); ?></label>
      <div class="give-donor-dashboard-text-control__input"><input id="company-783" type="text" value="<?php echo $myProfile['company']; ?>"></div>
   </div>
   <div class="give-donor-dashboard-text-control">
      <label class="give-donor-dashboard-text-control__label" for="primary-email"><?php echo __('Primary Email', 'givekindness'); ?></label>
      <div class="give-donor-dashboard-text-control__input">
         ...
         <input id="givekindness-primary-email" type="text" value="<?php echo $myProfile['emails']['primary']; ?>" name="givekindness-primary-email">
      </div>
   </div>
   <button class="give-donor-dashboard-button give-donor-dashboard-button--primary" id="givekindness-add-email">
      <?php echo __('Add Email', 'givekindness'); ?>
   ...
   <div class="give-donor-dashboard-select-control">
      ...
      <div class="css-2b097c-container">
         <div class="givekindness-form-control givekindness-country">
            <div class="givekindness-form-item">
         ...
         <div class="givekindness-country-list-menu">
            <div class="givekindness-country-list">
   ...
   <div class="give-donor-dashboard-field-row">
      <div class="give-donor-dashboard-select-control">
         ...
         <div class=" css-2b097c-container">
            <div class=" givekindness-form-control">
               <div class=" givekindness-form-item">
   ...
   <div class="give-donor-dashboard-heading"><?php echo __('Additional Info', 'givekindness'); ?></div>
   <div class="give-donor-dashboard-divider"></div>
   <fieldset class="give-donor-dashboard-radio-control">
      <legend class="give-donor-dashboard-radio-control__legend"><?php echo __('Anonymous Giving', 'givekindness'); ?></legend>
      <div class="give-donor-dashboard-radio-control__description"><?php echo __('This will prevent your avatar, first name, donation comments, and other information from appearing publicly on this organization’s website.', 'givekindness'); ?></div>
      <div class="give-donor-dashboard-radio-control__option"><input type="radio" name="format" id="0" value="0" checked=""><label for="0"><?php echo __('Public - show my donations publicly', 'givekindness'); ?></label></div>
      <div class="give-donor-dashboard-radio-control__option"><input type="radio" name="format" id="1" value="1"><label for="1"><?php echo __('Private - only organization admins can view my info', 'givekindness'); ?></label></div>
   </fieldset>
   <button class="give-donor-dashboard-button give-donor-dashboard-button--primary" id="givekindness-update-profile">
      <?php echo __('Update Profile', 'givekindness'); ?>
