<div class="give-donor-dashboard-tab-content" id="givekindness-profile" data-tab-content="givekindness-profile">
   ...
   <div class="give-donor-dashboard-field-row">
      ...
      <div class="give-donor-dashboard-text-control">
         <label class="give-donor-dashboard-text-control__label" for="first-name-699">First Name</label>
   ...
   <fieldset class="give-donor-dashboard-radio-control">
      <legend class="give-donor-dashboard-radio-control__legend">Anonymous Giving</legend>
      <div class="give-donor-dashboard-radio-control__description">This will prevent your avatar, first name, donation comments, and other information from appearing publicly on this organization’s website.</div>
      <div class="give-donor-dashboard-radio-control__option"><input type="radio" name="format" id="0" value="0" checked=""><label for="0">Public - show my donations publicly</label></div>
      <div class="give-donor-dashboard-radio-control__option"><input type="radio" name="format" id="1" value="1"><label for="1">Private - only organization admins can view my info</label></div>
   </fieldset>
   <button class="give-donor-dashboard-button give-donor-dashboard-button--primary">
      Update Profile 
