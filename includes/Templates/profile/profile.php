...
<div class="give-donor-dashboard-tab-content" id="give_kindness-profile" data-tab-content="give_kindness-profile">
   <div class="give-donor-dashboard-heading">
      <?php echo __('Profile Information', 'give_kindness'); ?>
   </div>
   ...
   <div class="give-donor-dashboard-avatar-control">
      <label class="give-donor-dashboard-avatar-control__label">
         <?php echo __('Avatar', 'give_kindness'); ?>
      </label>
        ...
        <div class="give-donor-dashboard-avatar-control__preview">
         ...
         <div class="give-donor-dashboard-avatar-control__dropzone">
            <div class="give-donor-dashboard-avatar-control__instructions">
               <p>
                  <?php echo __('Drag image here to set', 'give_kindness'); ?> <br><?php echo __('avatar or', 'give_kindness'); ?> 
                  <span class="give-donor-dashboard-avatar-control__select-link"><?php echo __('find image', 'give_kindness'); ?></span>
               </p>
            </div>
         </div>
      </div>
   ...
   <div class="give-donor-dashboard-field-row">
      ...
      <div class="give-donor-dashboard-text-control">
         <label class="give-donor-dashboard-text-control__label" for="gk-first-name"><?php echo __('First Name', 'give_kindness'); ?></label>
      ...
      <div class="give-donor-dashboard-text-control">
         <label class="give-donor-dashboard-text-control__label" for="gk-last-name">
            <?php echo __('Last Name', 'give_kindness'); ?>
         </label>
         <div class="give-donor-dashboard-text-control__input">
   ...
   <div class="give-donor-dashboard-text-control">
      <label class="give-donor-dashboard-text-control__label" for="gk-company">
         <?php echo __('Company', 'give_kindness'); ?>
      </label>
      <div class="give-donor-dashboard-text-control__input">
   ...
   <div class="give-donor-dashboard-text-control">
      <label class="give-donor-dashboard-text-control__label" for="primary-email">
         <?php echo __('Primary Email', 'give_kindness'); ?>
      </label>
      <div class="give-donor-dashboard-text-control__input">
      ...
      <div class="give_kindness-form-container">
         <div class="give_kindness-form-control give_kindness-country">
            <div class="give_kindness-form-item">
               ...
               <div class="give_kindness-form-child-item">
                  <div class="" style="display: inline-block;">
                     <input autocapitalize="none" autocomplete="off" autocorrect="off" id="gk-country" spellcheck="false" tabindex="0" type="text" aria-autocomplete="list" value="" style="box-sizing: content-box; width: 2px; background: 0px center; border: 0px; font-size: inherit; opacity: 1; outline: 0px; padding: 0px; color: inherit;">
                     <div style="position: absolute; top: 0px; left: 0px; visibility: hidden; height: 0px; overflow: scroll; white-space: pre; font-size: 14px; font-family: Arial; font-weight: 400; font-style: normal; letter-spacing: normal; text-transform: none;"></div>
                  </div>
               </div>
            </div>
   ...
   <div class="give-donor-dashboard-heading">
      <?php echo __('Additional Info', 'give_kindness'); ?>
   </div>
   <div class="give-donor-dashboard-divider"></div>
   <fieldset class="give-donor-dashboard-radio-control">
      <legend class="give-donor-dashboard-radio-control__legend">
         <?php echo __('Anonymous Giving', 'give_kindness'); ?>
      </legend>
      <div class="give-donor-dashboard-radio-control__description">
         <?php echo __('This will prevent your avatar, first name, donation comments, and other information from appearing publicly on this organization’s website.', 'give_kindness'); ?>
      </div>
      <div class="give-donor-dashboard-radio-control__option">
         <input type="radio" name="format" id="0" value="0" checked="">
         <label for="0">
            <?php echo __('Public - show my donations publicly', 'give_kindness'); ?>
         </label>
      </div>
      <div class="give-donor-dashboard-radio-control__option">
         <input type="radio" name="format" id="1" value="1">
         <label for="1">
            <?php echo __('Private - only organization admins can view my info', 'give_kindness'); ?>
         </label>
      </div>
   </fieldset>
