<div id="give-kindness-campaign-form-one">
    ...
    <div class="give-donor-dashboard-field-row">
        <div class="give-donor-dashboard-text-control">
            <label class="give-donor-dashboard-text-control__label" for="gk-mobile-code">
        ...
        <div class="give-donor-dashboard-text-control">
            ...
            <div class="give-donor-dashboard-text-control__input">
                <input id="gk-mobile-number" type="tel" placeholder="<?php echo __('Mobile number', 'give-kindness'); ?>"  maxlength="11">
            </div>
        </div>
    </div>
    ...
    <div class="give-kindness-media-items give-kindness-hide" id="give-kindness-media-items">
        ...
        <!-- <div class="give-kindness-media-item">
            <img src="http://via.placeholder.com/100x100" alt="">
            <a href="javascript:void(0);" class="give-kindness-media-item-remove" title="Remove Image">
                <svg style="width: 15px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="times-circle" class="svg-inline--fa fa-times-circle fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="#ff0000" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm121.6 313.1c4.7 4.7 4.7 12.3 0 17L338 377.6c-4.7 4.7-12.3 4.7-17 0L256 312l-65.1 65.6c-4.7 4.7-12.3 4.7-17 0L134.4 338c-4.7-4.7-4.7-12.3 0-17l65.6-65-65.6-65.1c-4.7-4.7-4.7-12.3 0-17l39.6-39.6c4.7-4.7 12.3-4.7 17 0l65 65.7 65.1-65.6c4.7-4.7 12.3-4.7 17 0l39.6 39.6c4.7 4.7 4.7 12.3 0 17L312 256l65.6 65.1z"></path>
                </svg>
            </a>
            <input type="hidden" name="rx-image" value="">
        </div>
        <div class="give-kindness-media-item">
            <img src="http://via.placeholder.com/100x100" alt="">
            <a href="javascript:void(0);" class="give-kindness-media-item-remove" title="Remove Image">
