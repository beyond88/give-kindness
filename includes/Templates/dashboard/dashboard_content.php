<?php 
    ...
    echo "</pre>";
?>
<div class="give-donor-dashboard-dashboard-content" id="givekindness-dashboard-content">
            ...
            <div class="give-donor-dashboard-table__row">
                ...
                <div class="give-donor-dashboard-table__pill">
                    ...
                    <div class="give-donor-dashboard-table__donation-receipt">
                        <a href="javascript:void(0)" data-receipt-no="<?php echo $id; ?>" class="view-receipt-btn">
...
<div class="give-donor-dashboard-tab-content" id="receipt-no-<?php echo $formId; ?>" style="display:none;">
   ...
   <div class="give-donor-dashboard-donation-receipt__table">
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail">
            ...
            <?php echo __('Donor Name', 'givekindness'); ?> 
         </div>
      ...
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail">
            ...
            <?php echo __('Email Address', 'givekindness'); ?> 
         </div>
   ...
   <div class="give-donor-dashboard-donation-receipt__table">
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Payment Status', 'givekindness'); ?> </div>
      ...
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Payment Method', 'givekindness'); ?></div>
         <div class="give-donor-dashboard-donation-receipt__value"><?php echo $method; ?></div>
      </div>
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Donation Amount', 'givekindness'); ?></div>
      ...
      <div class="give-donor-dashboard-donation-receipt__row give-donor-dashboard-donation-receipt__row--footer">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Donation Total', 'givekindness'); ?></div>
   ...
   <div class="give-donor-dashboard__donation-history-footer">
      <a href="javascript:void(0)" class="close-receipt" data-receipt-no="<?php echo $formId; ?>">
        ...
        <?php echo __('Back to Donation History', 'givekindness'); ?> 
      </a>
   </div>
</div>
<?php $reciepts--; ?>
