<div class="give-donor-dashboard-tab-content" id="give_kindness-campaign-statistics" data-tab-content="give_kindness-campaign-statistics">
    ...
    <div class="give-donor-dashboard-dashboard__stats">
        <div class="give-donor-dashboard-dashboard__stat">
            <div class="give-donor-dashboard-dashboard__figure" style="color: rgb(104, 187, 108);">
                ...
                <span id="give-kindness-goal">0</span>
            </div>
        ...
        <div class="give-donor-dashboard-dashboard__stat">
            <div class="give-donor-dashboard-dashboard__figure" style="color: rgb(104, 187, 108);">
                ...
                <span id="give-kindness-revenue">0</span>
            </div>
            <div class="give-donor-dashboard-dashboard__detail">
        ...
        <div class="give-donor-dashboard-dashboard__stat">
            <div class="give-donor-dashboard-dashboard__figure" style="color: rgb(104, 187, 108);">
                <span id="give-kindness-donations">0</span>
            </div>
