...
<div class="give-donor-dashboard-content" id="give_kindness-stats" data-tab-content="give_kindness-stats">
    <div class="give-donor-dashboard-heading">
        ...
        <?php echo __('Your Giving Stats','give_kindness'); ?>
    </div>
    <div class="give-donor-dashboard-dashboard__stats">
        <div class="give-donor-dashboard-dashboard__stat">
            ...
            <div class="give-donor-dashboard-dashboard__detail"><?php echo __('Number of donations','give_kindness');?></div>
        </div>
        <div class="give-donor-dashboard-dashboard__stat">
            ...
            <div class="give-donor-dashboard-dashboard__detail"><?php echo __('Lifetime donations','give_kindness');?></div>
        </div>
        <div class="give-donor-dashboard-dashboard__stat">
            ...
            <div class="give-donor-dashboard-dashboard__detail"><?php echo __('Average donation','give_kindness');?></div>
        </div>
    </div>
    <div class="give-donor-dashboard-heading">
        ...
        <?php echo __('Recent Donations','give_kindness');?>
    </div>
    <div class="give-donor-dashboard-table">
        <div class="give-donor-dashboard-table__header">
            <div class="give-donor-dashboard-table__column"><?php echo __('Donation','give_kindness');?></div>
            <div class="give-donor-dashboard-table__column"><?php echo __('Campaign','give_kindness');?></div>
            <div class="give-donor-dashboard-table__column"><?php echo __('Date','give_kindness');?></div>
            <div class="give-donor-dashboard-table__column"><?php echo __('Status','give_kindness');?></div>
        </div>
        ...
        <div class="give-donor-dashboard-table__rows">
            ...
            <div class="give-donor-dashboard-table__row">
                ...
                <div class="give-donor-dashboard-table__pill">
                    <div class="give-donor-dashboard-table__donation-id"><?php echo __('ID:', 'give_kindness'); ?>  <?php echo $reciept; ?></div>
                    <div class="give-donor-dashboard-table__donation-receipt">
                        <a href="javascript:void(0)" data-receipt-no="<?php echo $id; ?>" class="view-receipt-btn" onClick="viewReceipt(this, 'give_kindness-stats')">
                            <?php echo __('View Receipt', 'give_kindness'); ?> 
...
<div class="give-donor-dashboard-tab-content view-receipt-details" id="receipt-no-<?php echo $formId; ?>" style="display:none;">
   <div class="give-donor-dashboard-heading"><?php echo sprintf(__('Donation Receipt #%s', 'give_kindness'), $recieptNO); ?></div>
   <div class="give-donor-dashboard-donation-receipt__table">
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail">
            ...
            <?php echo __('Donor Name', 'give_kindness'); ?> 
         </div>
      ...
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail">
            ...
            <?php echo __('Email Address', 'give_kindness'); ?> 
         </div>
   ...
   <div class="give-donor-dashboard-donation-receipt__table">
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Payment Status', 'give_kindness'); ?> </div>
      ...
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Payment Method', 'give_kindness'); ?></div>
         <div class="give-donor-dashboard-donation-receipt__value"><?php echo $method; ?></div>
      </div>
      <div class="give-donor-dashboard-donation-receipt__row">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Donation Amount', 'give_kindness'); ?></div>
      ...
      <div class="give-donor-dashboard-donation-receipt__row give-donor-dashboard-donation-receipt__row--footer">
         <div class="give-donor-dashboard-donation-receipt__detail"> <?php echo __('Donation Total', 'give_kindness'); ?></div>
   ...
   <div class="give-donor-dashboard__donation-history-footer">
      <a href="javascript:void(0)" class="close-receipt" data-receipt-no="<?php echo $formId; ?>" onClick="closeReceipt(this, 'give_kindness-stats')">
        ...
        <?php echo __('Back to Donation History', 'give_kindness'); ?> 
      </a>
   </div>
</div>
<?php $reciepts--; ?>
