            ...
            <div class="give-donor-dashboard__auth-modal-content">
               <form class="give-donor-dashboard__auth-modal-form give-kindness-verify-part" id="give-kindness-verify-form" onSubmit="return false;">
                    <div class="give-donor-dashboard__auth-modal-instruction">
                        <?php echo __('Your account has not been verified. Please check your email. An email was sent.', 'give-kindenss'); ?> 
                    </div>
                    <div class="give-donor-dashboard-text-control">
                        <div class="give-donor-dashboard-text-control__input">
                            ...
                            <input id="give-kindness-verify-me" type="email" maxlength="60" placeholder="<?php echo __('Email', 'give-kindness'); ?>">
                        </div>
                    </div>
